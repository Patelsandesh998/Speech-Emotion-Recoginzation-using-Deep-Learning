...
pip install -r requirements.txt
pip install Flask imbalanced-learn resampy
mkdir -p datasets  # needed due to import-time scan in preprocessing.py
python app.py
...
├── static/               # Static JS/CSS for Flask
...
## Author
Sandesh Patel | B.Tech Computer Science | Srm University Andhra Pradesh
